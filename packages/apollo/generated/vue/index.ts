 ...
 */
export function useCardUserQuery(options: VueApolloComposable.UseQueryOptions<CardUserQuery, CardUserQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<CardUserQuery, CardUserQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<CardUserQuery, CardUserQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<CardUserQuery, CardUserQueryVariables>(CardUserDocument, {}, options);
}
export function useCardUserLazyQuery(options: VueApolloComposable.UseQueryOptions<CardUserQuery, CardUserQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<CardUserQuery, CardUserQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<CardUserQuery, CardUserQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<CardUserQuery, CardUserQueryVariables>(CardUserDocument, {}, options);
}
export type CardUserQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<CardUserQuery, CardUserQueryVariables>;
 ...
 * });
 */
export function useChangeCardUserPasswordMutation(options: VueApolloComposable.UseMutationOptions<ChangeCardUserPasswordMutation, ChangeCardUserPasswordMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<ChangeCardUserPasswordMutation, ChangeCardUserPasswordMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<ChangeCardUserPasswordMutation, ChangeCardUserPasswordMutationVariables>(ChangeCardUserPasswordDocument, options);
}
export type ChangeCardUserPasswordMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<ChangeCardUserPasswordMutation, ChangeCardUserPasswordMutationVariables>;
 ...
 * });
 */
export function useCardUserSignInMutation(options: VueApolloComposable.UseMutationOptions<CardUserSignInMutation, CardUserSignInMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CardUserSignInMutation, CardUserSignInMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<CardUserSignInMutation, CardUserSignInMutationVariables>(CardUserSignInDocument, options);
}
export type CardUserSignInMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<CardUserSignInMutation, CardUserSignInMutationVariables>;
